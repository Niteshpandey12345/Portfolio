(function($) {
	...
	$(document).ready(function() {
		...
		if ($('.gridlist').length) {
			new CBPGridGallery( document.getElementById( 'Conferences' ) );
			new CBPGridGallery( document.getElementById( 'HonourAwards' ) );
			new CBPGridGallery( document.getElementById( 'Meetups' ) );
			new CBPGridGallery( document.getElementById( 'Projects' ) );
			new CBPGridGallery( document.getElementById( 'Recommendations' ) );
		}
